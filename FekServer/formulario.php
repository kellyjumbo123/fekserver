...
<body>
    ...
    <section id="infraestructura" class="infra-section">
        <div class="container infra-container">
            ...
            <p>Nuestro sistema FabServer está diseñado con los más altos estándares para garantizar estabilidad y velocidad en el alojamiento web.</p>
            
            <div class="highlight-box">
                <p>La gestión de datos y aplicaciones se realiza mediante clusters de alta disponibilidad con redundancia geográfica, asegurando un 99.99% de uptime.</p>
            </div>
            
            <h3>Desarrollo</h3>
            <p>Nos enfocamos en crear soluciones web innovadoras y personalizadas que ayudan a nuestros estudiantes a destacar en el mundo digital.</p>
            <p>Desde sitios web interactivos hasta aplicaciones a medida, nuestro equipo combina creatividad y tecnología para crear experiencias digitales impactantes.</p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="benefits-grid">
                ...
                <div class="benefit-card">
                    ...
                    <p>Ofrecemos experiencias únicas que combinan café y tecnología de manera disruptiva.</p>
                </div>
